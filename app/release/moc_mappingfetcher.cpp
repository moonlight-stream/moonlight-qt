...
struct qt_meta_stringdata_CLASSMappingFetcherENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMappingFetcherENDCLASS = QtMocHelpers::stringData(
    "MappingFetcher",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMappingFetcherENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MappingFetcher::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMappingFetcherENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMappingFetcherENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMappingFetcherENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MappingFetcher, std::true_type>,
        // method 'handleMappingListFetched'
...
void *MappingFetcher::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMappingFetcherENDCLASS.stringdata0))
