...
struct qt_meta_stringdata_CLASSCliPairSCOPELauncherENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCliPairSCOPELauncherENDCLASS = QtMocHelpers::stringData(
    "CliPair::Launcher",
    "searchingComputer",
    "",
    "pairing",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCliPairSCOPELauncherENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      ...
      12,    2,   81,    2, 0x08,   10 /* Private */,
      14,    0,   86,    2, 0x08,   13 /* Private */,

 // methods: name, argc, parameters, tag, flags, initial metatype offsets
      15,    1,   87,    2, 0x02,   14 /* Public */,
      18,    0,   90,    2, 0x102,   16 /* Public | MethodIsConst  */,
...
Q_CONSTINIT const QMetaObject CliPair::Launcher::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCliPairSCOPELauncherENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCliPairSCOPELauncherENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCliPairSCOPELauncherENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void CliPair::Launcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (_t _q_method = &Launcher::pairing; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        ...
        {
            using _t = void (Launcher::*)();
            if (_t _q_method = &Launcher::success; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *CliPair::Launcher::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCliPairSCOPELauncherENDCLASS.stringdata0))
