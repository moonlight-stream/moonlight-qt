...
CenteredGridView {
    ...
    // Stays up until the PC wakes or the timeout fires, at which point we close
    // it explicitly (see wakeOpenTimeout and onOnlineRoleChanged). NoAutoClose
    // keeps it from dismissing on a stray click or Escape.
